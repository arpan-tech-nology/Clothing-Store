...
const Productdata = [
  {
    ...
    "variants": [
      ...
      },
      {
        ...
        "original_price": "450",
        "selling_price": "320",
        "featured_image": "images/bluetshirt.png",
        "rating": "4.3"
      },
      {
        "id": "13456734-3",
  ...
  },
  {
    ...
    "original_price": "800",
    "selling_price": "600",
    "featured_image": "images/pent.png",
    "rating": "4.2",
    "stock": "8",
    "variants": [
      {
  ...
  },
  {
    ...
    "original_price": "1800",
    "selling_price": "1400",
    "featured_image": "images/image 7 (1).png",
    "rating": "4.4",
    "stock": "20",
    "variants": [
      {
  ...
  },
  {
    ...
    "original_price": "900",
    "selling_price": "650",
    "featured_image": "images/image 8 (1).png",
    "rating": "4.1",
    "stock": "10",
    "variants": [
      {
  ...
  },
  {
    ...
    "original_price": "350",
    "selling_price": "250",
    "featured_image": "images/image 9 (1).png",
    "rating": "4.6",
    "stock": "25",
    "variants": [
      {
  ...
  },
  {
    ...
    "original_price": "5000",
    "selling_price": "3800",
    "featured_image": "images/image 10 (1).png",
    "rating": "4.9",
    "stock": "5",
    "variants": [
      {
  ...
  },
  {
    ...
    "original_price": "850",
    "selling_price": "600",
    "featured_image": "images/image 10 (2).png",
    "rating": "4.2",
    "stock": "22",
    "variants": [
      {
...
const subMenus = document.querySelectorAll('.nav-subitem');
...
const dropDownsSideBar = document.querySelectorAll('.dropdown');
const subMenusSideBar = document.querySelectorAll('.sub-menu');
dropDownsSideBar.forEach(dropDown => {
  dropDown.addEventListener('click', () => {
    subMenusSideBar.forEach(subMenu => {
      if (subMenu.dataset.target == dropDown.dataset.target) {
        if (subMenu.classList.contains('active')) {
          subMenu.classList.remove('active');
...
const clothcard = document.getElementById(sectionId);
  ...
  try {
    displayData.forEach(data => {
      ...
      headingDiv.classList.add('padding');

      const headingTag = document.createElement('h3');
      headingTag.innerHTML = data.title;
      ...
      let stars = Math.trunc(data.rating);
      let counter = 1;
      for (i = 0; i < 5; i++) {
        if (stars >= counter) {
     ...
     const paragraph1 = document.createElement('s');
      ...
      newDiv1.appendChild(headingDiv);
      headingDiv.appendChild(headingTag);
